...
liftWithIndexNamed :: forall s a b.(Typeable a, Typeable b, Typeable s, NFData b)
...
lift3WithIndexNamed :: forall s a b c d.(Typeable a, Typeable b, Typeable c, Typeable d, Typeable s, NFData d)
...
liftWithIndex :: forall s a b. (NFData b) => (Typeable a, Typeable b, Typeable s)
